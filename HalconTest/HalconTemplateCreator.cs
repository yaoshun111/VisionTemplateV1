...
{
    public partial class HalconTemplateCreator : UserControl
    {
        ...
        public void btDraw_Click(object sender, EventArgs e)
        {
            if (textBox1.Text != "")
            {
        ...
        public void btSaveTemplate_Click(object sender, EventArgs e)
        {   
